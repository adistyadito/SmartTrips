...
export function ResultsScreen({ formData, onBack }: ResultsScreenProps) {
  ...
  const generateItinerary = (): DayItinerary[] => {
    const activities = [
      {
        ...
        description: 'Hiking up Mount Batur for sunrise',
      ...
      },
      {
        ...
        description: 'Explore the charming streets and temples of Ubud',
        location: 'Ubud',
        cost: 250_000,
        rating: 4.8,
      },
      {
        ...
        description: 'Sample fresh produce and local crafts',
      ...
      },
      {
        ...
        description:
          'Enjoy authentic Balinese cuisine at a family-run restaurant',
      ...
      },
      {
        time: '2:00 PM',
        title: 'Spa & Wellness',
        description: 'Relax with traditional Balinese massage',
        location: 'Tjampuhan Spa',
        cost: 800_000,
        rating: 4.7,
      },
      {
        ...
        location: 'Agung Rai Museum of Art',
        cost: 180_000,
        rating: 4.7,
      },
      {
      ...
      },
      {
        ...
        description: 'Watch the sunset over the ocean',
      ...
      },
      {
        time: '6:30 PM',
        title: 'Food Tour',
        description: 'Taste street food and local delicacies',
        location: 'Seminyak Street Food',
        cost: 400_000,
        rating: 4.8,
      },
      {
        ...
        description: 'Enjoy traditional dance performance while dining',
    ...
    for (let day = 1; day <= formData.duration; day++) {
      ...
      let totalCost = dayActivities.reduce(
        (sum, activity) => sum + activity.cost,
        0
      );
      const maxAllowed = Math.max(
        0,
        formData.budget * budgetFactor - accumulatedCost
      );

      // Jika sisa budget terlalu kecil, kurangi jumlah aktivitas
      while (
        (totalCost > maxAllowed ||
          dayActivities.length * 250_000 > maxAllowed) &&
              ...
              <div className='grid grid-cols-1 md:grid-cols-4 gap-6'>
                ...
                <div className='flex items-center gap-3'>
                  ...
                  <div>
                    ...
                    <p className='text-xl font-semibold'>
                      Rp {formatRupiah(formData.budget)}
                    </p>
                  </div>
                </div>
          ...
          <Card className='shadow-lg border-0 bg-gradient-to-r from-green-600 to-emerald-600 text-white dark:bg-gradient-to-r dark:from-green-700 dark:to-emerald-800'>
            <CardContent className='p-8 text-center'>
              ...
              <p className='text-green-100 mb-6 text-lg'>
                Your personalized itinerary is ready! Book flights and hotels to
                make it happen.
              </p>
